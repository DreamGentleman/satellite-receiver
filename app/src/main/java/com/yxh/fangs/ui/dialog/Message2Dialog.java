...
public class Message2Dialog extends AlertDialog {
    ...
    public static Message2Dialog newInstance(final Context context, String title, String content, String time) {
        return new Message2Dialog(context, title, content, time);
    }

    public Message2Dialog(final Context context, String title, String content, String time) {
        super(context);
        mLayoutResId = R.layout.dialog_message2;
        mContext = context;
        mTitle = title;
        mContent = content;
        mTime = time;
    ...
    public Message2Dialog setPromptButtonClickedListener(OnPromptButtonClickedListener buttonClickedListener) {
        this.mPromptButtonClickedListener = buttonClickedListener;
        return this;
    }

    public Message2Dialog setLayoutRes(int resId) {
