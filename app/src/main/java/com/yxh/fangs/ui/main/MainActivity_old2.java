...
public class MainActivity_old2 extends BaseActivity implements OperationCallback {
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult result) {
                for (android.location.Location location : result.getLocations()) {
                    ...
                    Toast.makeText(MainActivity_old2.this, text, Toast.LENGTH_SHORT).show();
    ...
    public void startTyphoonSimulation() {
        ...
        for (int i = 0; i < levels.length; i++) {
            ...
            handler.postDelayed(() -> {
                ...
                if ("强台风".equals(level)) {
                    Toast.makeText(MainActivity_old2.this, "警告警告", Toast.LENGTH_SHORT).show();
                }
