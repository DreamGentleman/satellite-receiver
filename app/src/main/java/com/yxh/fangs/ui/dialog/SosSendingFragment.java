...
public class SosSendingFragment extends DialogFragment {

    private TextView tvSos;
    private String sosContent;
    private String sosType;

    public static SosSendingFragment newInstance(String sosType, String sosContent) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.dialog_sos, container, false);
        ...
        tvSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismissDialog();
                SosCancelDialog.newInstance(getActivity(), "提示消息", "本次SOS紧急求助信息已取消", "").show();
            }
        });
        startPolling();
        return rootView;
