...
public class SerialNumberParserV2 {
     ...
     * 解析序列号的详细信息
     */
    public static SerialNumberParserV2.SerialInfo parseSerialInfo(String serial, String deviceId) {
        SerialNumberParserV2.SerialInfo info = new SerialNumberParserV2.SerialInfo();
